...
% X1=pp(1,6).time;
% Y1=pp(1,6).signals.values*sqrt(3);
% X2=out(1,6).T1_tem.time;
% Y2=out(1,6).T1_tem.signals.values;
...
% 创建 title
title('五电平开关频率250Hz三相输出功率与IGCT结温','FontWeight','bold');
