...
f_out = frequency_modulate_start : frequency_modulate_interval : frequency_modulate_end;                 %调制频率输入量
...
for ii = 1:3
    ...
    for i = 1:step
        ...
        in(i) = in(i).setVariable('f_out',f_out(i));
    end
